...
/// </summary>
public class testCFOP4 : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        if ((UnityEngine.Input.GetKeyUp(KeyCode.F5)))
        {
            ...
            Debug.Log("CFOP test initiated");
            Time.timeScale = 100;

            string filename = "CFOP method test( " + seed.ToString() + " " + number_of_shuffles.ToString() + " " + length_of_shuffles.ToString() + ").txt";
        ...
        if (test)
        {
            ...
            else
            {
                ...
                string filename = "CFOP method test( " + seed.ToString() + " " + number_of_shuffles.ToString() + " " + length_of_shuffles.ToString() + ").txt"; // file format: test parameters( # # # ).txt
